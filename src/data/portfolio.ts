...
export const content: Record<Language, Content> = {
    ...
    projects: [
      ...
      },
      {
        ...
        highlights: [
          ...
          'Go backend with Prisma handling data access on MariaDB',
          'Responsive UI built with React, TypeScript, and Tailwind CSS',
        ],
        tech: ['React', 'TypeScript', 'Tailwind CSS', 'Bun', 'Go', 'Prisma', 'MariaDB'],
        github: undefined,
        demo: undefined,
  ...
  th: {
    ...
    projects: [
      {
        title: '1MOBY',
        description: 'แพลตฟอร์ม LMS สำหรับประเมินและพัฒนาทักษะของพนักงานในบริษัท\nช่วยแก้ปัญหาการที่บริษัทต้องพึ่งพา Excel',
        highlights: [
      ...
      {
        title: 'Tourism',
        description: 'ช่วยแนะนำสถานที่ท่องเที่ยวในชุมชนให้กับผู้เข้าชมเว็บไซต์ และช่วยเพิ่มรายได้ให้กับชุมชน',
        highlights: [
          'มีจุดสีบนแผนที่บอกประเภทของสถานที่ท่องเที่ยวในแต่ละพื้นที่',
          'Go backend ทำงานร่วมกับ Prisma สำหรับจัดการข้อมูลบน MariaDB',
